...
Admin Password: ${res.data.company.admin_password}`;
  ...
  return (
    <div className="auth-container company-registration">
      ...
      <p className="subtitle">Create a custom email domain for your organization</p>
      ...
      <form onSubmit={handleCompanyRegistration}>
        ...
        <div className="input-wrapper domain-input">
          <input
            ...
            maxLength={50}
            style={{
              paddingRight: '50px' // Make room for the status icon
            }}
          />
          <FaGlobe className="input-icon" style={{ right: '35px' }} />
          {getDomainStatusIcon()}
        </div>
