...
def send_mail():
    ...
    sender_id = generate_user_id(sender, cipher.decrypt(users[sender].encode()).decode())
    recipient_id = generate_user_id(recipient, cipher.decrypt(users[recipient].encode()).decode())
